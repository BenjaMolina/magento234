define(
    [
        ...
        'CasaLum_OneStepCheckout/js/action/validate-shipping-info',
        'CasaLum_OneStepCheckout/js/action/showLoader',
        'CasaLum_OneStepCheckout/js/action/save-shipping-address',
        'CasaLum_OneStepCheckout/js/action/set-shipping-information',
        'CasaLum_OneStepCheckout/js/model/shipping-rate-service',
        'CasaLum_OneStepCheckout/js/action/save-additional-information',
    ...
    function (
        ...
        return Component.extend({
            defaults: {
                template: 'CasaLum_OneStepCheckout/opcheckout'
            },

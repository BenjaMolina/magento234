define(
    [
        ...
        'CasaLum_OneStepCheckout/js/model/validate-shipping',
        'Magento_Checkout/js/model/shipping-rates-validator',
        'CasaLum_OneStepCheckout/js/action/save-default-payment'
    ],
    function (
        $,
        _,
        ...
        return Component.extend({
            defaults: {
                template: 'CasaLum_OneStepCheckout/shipping-method/list'
            },

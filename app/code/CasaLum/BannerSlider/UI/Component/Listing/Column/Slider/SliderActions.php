...
class SliderActions extends Column
{
     ...
     * Url path
     */
    const URL_PATH_EDIT = 'casalum_banners_slider/slider/edit';
    const URL_PATH_DELETE = 'casalum_banners_slider/slider/delete';
    const URL_PATH_DETAILS = 'casalum_banners_slider/slider/details';
